Feature: To create job entry in the application
  ...
  Scenario: To create job entry in JSON format
    ...
    And request { jobId: 3, jobTitle: 'Software Engg - 3', jobDescription: 'To develop android application', experience: ['Google', 'Apple', 'Mobile Iron', 'PWC'], project: [{ projectName: 'Movie App', technology: ['Kotlin', 'SQL Lite', 'Gradle'] }] }
